...
enum SettingsViewSectionItem {
  case version(SettingItemCellReactorType)
  case icons(SettingItemCellReactorType)
  case openSource(SettingItemCellReactorType)
  case logout(SettingItemCellReactorType)
}
